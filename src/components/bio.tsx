...
function Bio(){
    return(
        <Fade direction={screen.width > 768 ? 'left' : 'up'} fraction={0.1} duration={700} className="m-5 w-5/6 md:w-2/5 sm:w-5/6 shadow-lg mt-20 p-4 lg:p-10 md:p-10 rounded-xl" cascade>
            <div>
