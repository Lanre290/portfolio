...
function Education(){
    return(
        <Fade direction={screen.width > 768 ? 'right' : 'up'} fraction={0.1} duration={700} className="m-5 w-5/6 md:w-2/5 sm:w-5/6 shadow-lg mt-20  p-10 rounded-xl" cascade>
            <div className="">
                <h3 className="under-line px-5 w-fit py-4 text-3xl" style = {{width: 'fit-content'}}>Education</h3>
